...
My past articles featured a strategy to [Go Big](https://andersun.substack.com/p/draft-one) with creative endeavors, a tactic for small but meaningful progress with [Pomodoro](https://andersun.substack.com/p/pomodoro), a principle of [Don’t Miss Two](https://andersun.substack.com/p/dont-miss-two) days, and a framework to reduce uncertainty with [Bones Before Flesh](https://andersun.substack.com/p/bones-before-flesh). My next learning was another strategy.
