...
const AboutPage = () => {
  return (
    <Layout pageTitle="About">
      <h2>About</h2>
      <p>I build products, write stories, and live in Minnesota with my wife.</p>
      <p><b>Re: Work</b> — I build technology products, with a focus on machine learning and data science. I'm interested in tools that encourage care and accountability.</p>
      ...
      <p><b>Re: Roots</b> — I'm Catholic, from Michigan, and a proud Wolverine.</p>
