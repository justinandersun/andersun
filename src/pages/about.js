...
const AboutPage = () => {
  return (
    <Layout pageTitle="About">
      ...
      <p>I am a partner, brother, son, cousin, grandson, friend, nephew, and citizen (roughly in that order).</p>
      ...
      <p>I originate from West Michigan and still bear the markings of a Midwesterner: polite, nasally, with a tendency to discuss the weather.</p>
      ...
      <ul>
        ...
        <li>Moderately open to new experiences but prefer routine</li>
      </ul>
